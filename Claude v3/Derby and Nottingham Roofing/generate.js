...
/* four-colour Google "G" (same asset as review.html) + star, shared by the reviews UI */
...
const STAR_SVG = '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l2.9 6.3 6.9.6-5.2 4.6 1.6 6.8L12 17.3 5.8 20.9l1.6-6.8L2.2 8.9l6.9-.6z"/></svg>';
const GOOGLE_REVIEWS_URL = "https://g.page/r/CeIJ2bFhP2mrEBM";
...
function reviewsSection() {
  ...
  <div class="section-head center"><span class="eyebrow">Don't just take our word for it</span><h2>What our customers say</h2><p>Rated by homeowners across Derby &amp; Nottingham.</p></div>
  <div class="rev-badge-wrap"><a class="rev-badge" href="${GOOGLE_REVIEWS_URL}" target="_blank" rel="noopener" aria-label="See our Google reviews">${G_SVG}<span class="rb-mid"><span class="rb-score">5.0</span><span class="rb-stars">${STAR_SVG.repeat(5)}</span></span><span class="rb-label">Google rating</span></a></div>
...
<script>
  ...
  var GOOGLE_REVIEW_URL   = "https://g.page/r/CeIJ2bFhP2mrEBM/review";
