...
<section class="hero" id="top">
  <div class="hero-slides">
    <video class="hero-video" id="heroVideo" muted loop playsinline autoplay preload="auto" poster="assets/img/hero-poster.jpg" disablepictureinpicture>
...
.logo-badge{position:relative;z-index:2;display:inline-flex;padding:12px 16px;margin:0 auto 16px;background:rgba(12,14,19,.5);backdrop-filter:blur(4px);border-radius:14px;box-shadow:0 10px 24px rgba(0,0,0,.3)}
.logo-badge img{height:64px;width:auto;object-fit:contain;display:block}
